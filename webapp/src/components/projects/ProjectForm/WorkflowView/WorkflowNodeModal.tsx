...
export function WorkflowNodeModal({
  ...
  const title = isInput ? '타겟 & 모듈' : (toolDef?.label ?? toolId);
  ...
  function renderSection() {
    ...
    switch (toolId) {
      case 'SubdomainDiscovery':
        return <SubdomainDiscoverySection {...baseProps} />;
      case 'Urlscan':
        return <UrlscanSection {...baseProps} />;
      case 'Shodan':
        return <ShodanSection {...baseProps} />;
      case 'OsintEnrichment':
        return <OsintEnrichmentSection {...baseProps} />;
      case 'Naabu':
        return <NaabuSection {...baseProps} />;
      case 'Masscan':
        return <MasscanSection {...baseProps} />;
      case 'Nmap':
        return <NmapSection {...baseProps} />;
      case 'Httpx':
        return <HttpxSection {...baseProps} />;
      case 'Katana':
        return <KatanaSection {...baseProps} />;
      case 'Hakrawler':
        return <HakrawlerSection {...baseProps} />;
      case 'Jsluice':
        return <JsluiceSection {...baseProps} />;
      case 'Ffuf':
        return <FfufSection {...extendedProps} />;
      case 'Gau':
        return <GauSection {...baseProps} />;
      case 'ParamSpider':
        return <ParamSpiderSection {...baseProps} />;
      case 'Kiterunner':
        return <KiterunnerSection {...baseProps} />;
      case 'Arjun':
        return <ArjunSection {...baseProps} />;
      case 'JsRecon':
        return <JsReconSection {...extendedProps} />;
      case 'Nuclei':
        return <NucleiSection {...baseProps} />;
      case 'GraphqlScan':
        return <GraphqlScanSection {...extendedProps} />;
      case 'SubdomainTakeover':
        return <TakeoverSection {...baseProps} />;
      case 'VhostSni':
        return <VhostSniSection {...baseProps} />;
      case 'CveLookup':
        return <CveLookupSection {...baseProps} />;
      case 'Mitre':
        return <MitreSection {...baseProps} />;
      case 'SecurityChecks':
        return <SecurityChecksSection {...baseProps} />;
      case 'Uncover':
        return <OsintEnrichmentSection {...baseProps} />;
      case 'input':
        return <TargetSection {...extendedProps} />;
      default:
        return <p>이 모듈에 대한 설정이 없습니다.</p>;
    }
  }
  ...
  return (
    <Modal
      ...
      headerActions={
        ...
        >
          {toolId && (
            <WikiInfoButton target={toolId} title={`Open ${title} wiki page`} />
          )}
          {onSave && (
            <button
              type="button"
