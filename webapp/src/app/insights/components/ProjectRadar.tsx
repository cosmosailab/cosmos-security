...
const METRICS = [
  ...
  {
    key: 'IPs',
    get: (d: GraphOverviewData) =>
      d.nodeCounts.find((n) => n.label === 'IP')?.count || 0,
  },
  {
    key: 'Ports',
    get: (d: GraphOverviewData) =>
      d.nodeCounts.find((n) => n.label === 'Port')?.count || 0,
  },
  {
    key: 'Endpoints',
    get: (d: GraphOverviewData) => d.endpointCoverage.endpoints,
  },
  {
    key: 'Technologies',
    get: (d: GraphOverviewData) =>
      d.nodeCounts.find((n) => n.label === 'Technology')?.count || 0,
  },
  {
    key: 'Vulnerabilities',
    get: (d: GraphOverviewData) =>
      d.nodeCounts.find((n) => n.label === 'Vulnerability')?.count || 0,
  },
];
