...
interface AttackKillChainFunnelProps {
  data:
    | { phase: string; totalSteps: number; successSteps: number }[]
    | undefined;
  isLoading: boolean;
}
...
export function AttackKillChainFunnel({
  data,
  isLoading,
}: AttackKillChainFunnelProps) {
